...
| Sentinel-2 Satellite Data      | Resampled to 30m (bilinear) for alignment; derived vegetation indices and weighted temporal mosaic | EVI, Albedo, vegetation stress indices, spectral anomaly scores.                     | [Microsoft Planetary Computer](https://planetarycomputer.microsoft.com) |
| NYC Tree Census (2015)         | Aggregated tree metrics with normal/annular buffers (500m–15,000m)          | Tree count, avg_tree_health, tree_size, ring features, aggregated stats.             | [NYC Open Data](https://opendata.cityofnewyork.us)                      |
| NYC Building Footprints        | Spatial joins across normal/annular buffers (500m–15,000m)                  | Building count/height/area, ground elevation, ring features, aggregated stats.        | [SHP File](link_here)<br>[KML File](link_here)                          |
| NYC Traffic 2022               | Aggregated traffic volume/count across buffers (500m–15,000m)               | Traffic volume, traffic count, ring features, aggregated stats.                       | [NYC Open Data](https://opendata.cityofnewyork.us)                      |
| OSMNX Street Networks          | Network analysis using OSMnx library                                         | Distance to water/park, street length, road/node density, area types.                 | [OSMNX Docs](https://osmnx.readthedocs.io)                              |
